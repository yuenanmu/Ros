...
def img_callback(msg):
    ...
    if M["m00"] > 0:
        ...
        # 计算速度命令
        vel_forward =0.003*(image_height//2-target_y)  # 前进速度
        vel_cmd.linear.x = vel_forward
        vel_turn=0.005*(image_width//2-target_x) #转向速度，目标图像中心
...
if __name__=="__main__":
    ...
    vel_pub=rospy.Publisher("/cmd_vel",Twist,queue_size=10) #发布速度消息
    #创建窗口
